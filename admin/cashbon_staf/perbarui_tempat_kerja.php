...
<?php
		...
		date_default_timezone_set('Asia/Jakarta');
			$tanggal = date('d-m-Y');
		if(isset($_POST['perbarui_tempat_kerja'])){
			$tempat_kerja = $_POST['tempat_kerja_baru'];
			$id = $_POST['id'];
				$sql = "update cashbon_staf set Tempat_Kerja = '$tempat_kerja' WHERE ID = '$id'";
				$query = sqlsrv_query($conn, $sql);
				if($query) {
					$msg = "<h3 align=center>SUKSES!<br></h3><p align=center>Perubahan tempat kerja menjadi <b>".$tempat_kerja."</b> Berhasil!";
					} else {
