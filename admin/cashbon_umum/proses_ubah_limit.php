...
<?php
		...
		date_default_timezone_set('Asia/Jakarta');
			$tanggal = date('d-m-Y');
		if(isset($_POST['ubah_limit'])){
			$limit = $_POST['limit'];
			$id = $_POST['id'];
				$sql = "update cashbon_umum set limit = '$limit' WHERE ID = '$id'";
				$query = sqlsrv_query($conn, $sql);
				if($query) {
					$msg = "<h3 align=center>SUKSES!<br></h3><p align=center>Perubahan Limit menjadi <b>Rp ".number_format($limit)."</b> Berhasil!";
					} else {
