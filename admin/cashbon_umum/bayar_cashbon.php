...
<?php
		...
		if(isset($_POST['bayar'])){
			...
			$id = $_POST['id'];
				$sql = "insert into transaksi_cashbon_umum(IDC, Jumlah, Tanggal, Keterangan) values('$id','-$jumlah','$tanggal','$keterangan')";
				$query = mysqli_query($conn, $sql);
				if($query) {
					$msg = "<h3 align=center>SUKSES!<br></h3><p align=center>Bayar Cashbon Sejumlah : <b>".number_format($jumlah)."</b> Berhasil!";
					} else {
