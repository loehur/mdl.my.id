...
<?php
		...
		if(isset($_POST['tarik'])){
			...
			$id = $_POST['id'];
				$sql = "insert into transaksi_investor(IDC, Keterangan, Jumlah, Tanggal) values('$id','$ket','-$jumlah','$tanggal')";
				$query = mysqli_query($conn, $sql);
				if($query) {
					$msg = "<h3 align=center>SUKSES!<br></h3><p align=center>Penarikan Investasi Sejumlah : <b>".number_format($jumlah)."</b> Berhasil!";
					} else {
